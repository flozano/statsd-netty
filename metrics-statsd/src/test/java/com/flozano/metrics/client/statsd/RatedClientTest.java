...
import static com.flozano.metrics.test.PredicateMatcher.compliesWith;
...
import com.flozano.metrics.client.statsd.RatedStatsDClient;
...
public class RatedClientTest {
	...
	@Before
	public void setUp() {
		inner = mock(MetricsClient.class);
